...
- The proposed method performs well for all series except two.

- The most important features are the first lag and summary statistics computed from the 30-lag window.

 - Qualitative variables are the least important in the global variable importance ranking.
